    ...
    return (
      <footer className="p-10 footer text-base-content footer-center">
        <div className="grid grid-flow-col gap-4">
          <a className="link link-hover" href="index.html">
            Home
          </a>
          <a className="link link-hover" href="about.html">
            How to use?
          </a>
          <a className="link link-hover" href="contact.html">
            Contact
          </a>
        </div>
        <div>
          <div className="grid grid-flow-col gap-4">
            <a href="https://github.com/FIT3164Group1/Project">
              <svg
        ...
        <div>
          ...
          <p className="text-center">Cooper Corbett</p>
